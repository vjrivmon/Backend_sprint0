/**
 * @file servidorREST.js
 * @brief Servidor Express que se conecta a una base de datos MariaDB y expone una API REST con documentación Swagger.
 * 
 * Este archivo configura un servidor Express que se conecta a una base de datos MariaDB
 * utilizando un pool de conexiones. Proporciona rutas para consultar y agregar datos a la base de datos,
 * y documenta la API utilizando Swagger.
 * 
